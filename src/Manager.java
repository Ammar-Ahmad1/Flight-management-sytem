...
public class Manager {
    ...
    public void createFlights() {
        ...
        System.out.println("Enter flight Number(Integers only).");
        try {
          FN = scan1.nextInt();
        }catch(Exception e) {
        	System.out.println("entered format is incorrect, enter only numbers");
        ...
        dt = scan2.nextLine();
        System.out.println("Enter flight capacity (50-100).");
        c = scan1.nextInt();
        ...
        try {
            FileWriter myWriter = new FileWriter("Flights.txt",true);
    ...
    public void bookSeat(int flightNumber, Passenger p) {
        ...
        if (flag == true && (seats > 0)) {
            ...
            try {
                FileWriter myWriter = new FileWriter("passengers.txt",true);
    ...
    public static void main(String[] args)throws InterruptedException {
        ...
        while (flag != true) {
            System.out.println("press 1 to create a flight.");
            System.out.println("press 2 to go to reservation menu");
    ...
    //====================================================================================================    
      flag=false;
      try {
          File myObj = new File("passengers.txt");
          if (myObj.createNewFile()) {
          	  System.out.println("File created.");
          } else {
            System.out.println("File already exists.");
        ...
        while (flag != true) {
            ...
            System.out.println("Enter 1 if you would like to display all flights (displayAvailableFlights method)");
            System.out.println("Enter 2 if you would like to get information on a flight (getFlight method)");
            System.out.println("Enter 3 if you would like to book a seat (bookSeat method)");
            System.out.println("Enter 0 if you would like to terminate the program");
            input = scan1.nextLine();
            switch (input) {
                case "1":
                    System.out.println("Enter flight origin");
